# Anonymous at IMO 2026 


The **Anonymous team have aced all 6/6 IMO 2026 problems** using a *fully agentic, YOLO-style approach*. Every solution has been **formally verified** by Lean 4 . The project is pinned to Lean 4.31.0 and Mathlib v4.31.0.
...
Both the Anonymous(GPT-5.6) and Anonymous(Kimi-K3) workers solved all six problems. The Kimi-k3 run is a
...
| Problem | Anonymous (GPT-5.6) | Anonymous (Kimi-k3) | AxiomProver |
| --- | ---: | ---: | ---: |
