# Anonymous at IPhO 2026


The **Anonymous team aced all three theory problems of the 56th International
...
The Anonymous GPT-5.6 Sol and Kimi K3 Max natural-language submissions each
answered all 23 theory subparts and received full credit on every problem in
their grading audits.

| Problem | Anonymous (GPT-5.6 Sol) | Anonymous (Kimi K3 Max) |
| --- | ---: | ---: |
