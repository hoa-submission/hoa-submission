...
Use Lean 4.32.2 and the implementation/review loop.
...
5. Commit each completed round and write the requested round summary.
6. Address every independent review finding until the review loop finalizes the loop.
