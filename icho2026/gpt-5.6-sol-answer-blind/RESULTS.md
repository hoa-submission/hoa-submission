...
- [Source code](https://github.com/anonymous/science-mango/tree/chemistry-blind-solver-gpt/icho_2026_run)
- [Dataset](https://huggingface.co/datasets/anonymous-lab/icho-2026)

## Report provenance

The scope, checks, and limitations above are reproduced from
[`science-mango/icho_2026_run/RESULTS.md` at commit `515f485c`](https://github.com/anonymous/science-mango/blob/515f485c841b55a349a755aa3afa4659a8c6cd4d/icho_2026_run/RESULTS.md).
