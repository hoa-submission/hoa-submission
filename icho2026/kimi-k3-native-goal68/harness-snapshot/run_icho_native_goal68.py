...
BASE = Path('/home/user/icho-native-goal-gpt68-20260913-01')
MODEL = 'gpt-5.6-sol'
CONCURRENCY = 32
...
def args_for(root):
    return SimpleNamespace(runtime=BASE/'runtime', seed=BASE/'seed', campaign=root/'campaign',
        private_home=root/'private-home', packages=Path('/home/user/icho-full68-dependencies/.lake/packages'),
        lean_bin=Path('/home/user/.elan/toolchains/leanprover--lean4---v4.31.0/bin'), python=infra.PYTHON,
        codex=Path('/home/user/.codex/packages/standalone/releases/0.153.4-x86_64-unknown-linux-musl/bin/codex'),
        bwrap=Path('/home/user/icho-full68-runtime/tools/bubblewrap/usr/bin/bwrap'))
...
def prepare():
    ...
    bundle = Path('/home/user/icho-full68-controller-v2/questions_only.jsonl')
    ...
    save(BASE/'manifest.json',dict(model=MODEL, reasoning_effort='xhigh', concurrency=32,
        ...
        fresh_answer_blind=True, solver_loop=False, supplementary_assumptions=[],
