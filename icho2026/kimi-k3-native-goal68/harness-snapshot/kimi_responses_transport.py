...
a hardware vendor's Kimi converter otherwise loses tool-name resolution. No messages,
    ...
    class Handler(BaseHTTPRequestHandler):
        ...
        def do_POST(self):
            ...
            try:
                ...
                try:
                    response = post_with_backoff(lambda: requests.post('https://inference-api.vendor.example/v1/responses',
