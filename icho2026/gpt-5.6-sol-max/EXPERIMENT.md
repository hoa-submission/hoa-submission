# IChO 2026 review-loop experiment: GPT-5.6 max

## Outcome

Nine isolated review-loop workers solved Q1 through Q9 in parallel. Every
worker exited successfully, every final harness state is complete, every
...
- Alignment reviewer: `gpt-5.6-sol` at `max`
- Review model: `gpt-5.6-sol` at `max`
- Parallelism: nine isolated Git worktrees and branches
- Maximum review iterations per problem: 8
...
Each worker had a separate `CODEX_HOME`, its own harness loop state, and
...
|---|---|---:|---:|---:|---|
| Q1 | `worker-gpt56max-q01` | `26a40f5` | 0 | 8168 | COMPLETE |
| Q2 | `worker-gpt56max-q02` | `295cb5c` | 0 | 8827 | COMPLETE |
| Q3 | `worker-gpt56max-q03` | `3cdb991` | 0 | 13954 | COMPLETE |
| Q4 | `worker-gpt56max-q04` | `1f97e01` | 0 | 8074 | COMPLETE |
| Q5 | `worker-gpt56max-q05` | `6d14b81` | 0 | 8595 | COMPLETE |
| Q6 | `worker-gpt56max-q06` | `10efb99` | 1 | 11256 | Corrected significant figures; COMPLETE |
| Q7 | `worker-gpt56max-q07` | `dcfe5f7` | 0 | 10309 | COMPLETE |
| Q8 | `worker-gpt56max-q08` | `0a73325` | 0 | 10803 | COMPLETE |
| Q9 | `worker-gpt56max-q09` | `d777b5f` | 0 | 11476 | COMPLETE |
...
- runner state `complete`, exit code 0, and `harness_complete=true`;
- a nonempty `complete-state.md` and `finalize-summary.md`;
...
Alignment reviewers were unaffected and performed the substantive
...
- Consolidated worktree: `/root/user-workspace/icho-2026-gpt56-sol-max-results`
- Original GPT-5.5 result branch: `main` in the source repository
- Original GPT-5.5 harness/runtime archive:
  `/root/user-workspace/icho-2026-gpt55-xhigh-archive-20260809`
