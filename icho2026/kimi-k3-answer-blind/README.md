...
`anonymous/science-mango`. The run used four-way target concurrency, completed
...
[`icho_2026_kimi_k3_answer_blind.jsonl`](https://huggingface.co/datasets/anonymous-lab/icho-2026/blob/main/data/icho_2026_kimi_k3_answer_blind.jsonl).
